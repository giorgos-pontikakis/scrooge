...
** Γιατί πρέπει να κάνω initialize body και value για simple checkboxes (όχι set);
(<2012-08-15 Τετ> - temtx.lisp)
** Γιατί δεν γίνεται σωστή επιλογή σε κώδικα 'input-radio-set
